          ...
          {isContactUsActive ? (
            <Link to="/contact-us">
              <div className="flex justify-start gap-x-3">
                ...
                <img className="hover:scale-125 duration-150" src="/external-link.svg" height="20" width="20"/>
              </div>
            </Link>
            ):null
          }
      ...
      <div className="bg-[#282828] h-[300px] flex justify-center shadow-[0px_20px_0px_0px_rgba(0,0,0,0.3)] z-10 relative">
        <div className="grid place-content-center">
          ...
          <div className="flex justify-center gap-x-10 my-5">
            ...
            <Link to="https://www.instagram.com/ateneomisa/" className="hover:scale-125 duration-150">
              <StaticImage src="../../../static/images/instagramlogo.png" quality={100} height={30}></StaticImage>
            </Link>

            <Link to="https://twitter.com/AteneoMISA" className="hover:scale-125 duration-150">
              <StaticImage src="../../../static/images/twitterlogo.png" quality={100} height={30}></StaticImage>
            </Link>

            <Link to="https://www.linkedin.com/company/ateneomisa/" className="hover:scale-125 duration-150">
              <StaticImage src="../../../static/images/linkedinlogo.png" quality={100} height={30}></StaticImage>
            </Link>

            <Link to="https://www.tiktok.com/@ateneomisa" className="hover:scale-125 duration-150">
              <StaticImage src="../../../static/images/tiktoklogo.png" quality={100} height={30}></StaticImage>
            </Link>

            <Link to="mailto: ateneo.misa@gmail.com" className="hover:scale-125 duration-150">
